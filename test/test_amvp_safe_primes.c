...
static void setup(void) {
     ...
     */
    rv = amvp_cap_safe_primes_enable(ctx, AMVP_SAFE_PRIMES_KEYGEN, &dummy_handler_success);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_SAFE_PRIMES_KEYGEN,
                                  AMVP_PREREQ_DRBG, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_SAFE_PRIMES_KEYGEN,
     ...
     */
    rv = amvp_cap_safe_primes_enable(ctx, AMVP_SAFE_PRIMES_KEYVER, &dummy_handler_success);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_SAFE_PRIMES_KEYVER,
                                  AMVP_PREREQ_DRBG, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_SAFE_PRIMES_KEYVER,
                                  AMVP_PREREQ_SHA, cvalue);
...
Test(SAFE_PRIMES_API, empty_ctx) {
    ...
    rv  = amvp_safe_primes_kat_handler(ctx, obj);
...
Test(SAFE_PRIMES_API, null_ctx) {
    ...
    rv  = amvp_safe_primes_kat_handler(NULL, obj);
