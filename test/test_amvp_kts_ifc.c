...
static void setup(void) {
    ...
    rv = amvp_cap_kts_ifc_enable(ctx, AMVP_KTS_IFC, &dummy_handler_success);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_KTS_IFC, AMVP_PREREQ_RSA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_KTS_IFC, AMVP_PREREQ_RSADP, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_KTS_IFC, AMVP_PREREQ_SHA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_set_prereq(ctx, AMVP_KTS_IFC, AMVP_PREREQ_DRBG, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kts_ifc_set_param_string(ctx, AMVP_KTS_IFC, AMVP_KTS_IFC_FIXEDPUBEXP, expo_str);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kts_ifc_set_param_string(ctx, AMVP_KTS_IFC, AMVP_KTS_IFC_IUT_ID, "CAFEBABE");
    cr_assert(rv == AMVP_SUCCESS);
...
Test(KTS_IFC_API, empty_ctx) {
    ...
    rv  = amvp_kts_ifc_kat_handler(ctx, obj);
...
Test(KTS_IFC_API, null_ctx) {
    ...
    rv  = amvp_kts_ifc_kat_handler(NULL, obj);
...
Test(KTS_IFC_API, null_json_obj, .init = setup, .fini = teardown) {
    rv  = amvp_kts_ifc_kat_handler(ctx, NULL);
