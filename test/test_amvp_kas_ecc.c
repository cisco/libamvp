...
static void setup(void) {
    ...
    rv = amvp_cap_kas_ecc_enable(ctx, AMVP_KAS_ECC_SSC, &dummy_handler_success);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_SSC, AMVP_KAS_ECC_MODE_NONE, AMVP_PREREQ_ECDSA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_SSC, AMVP_KAS_ECC_MODE_NONE, AMVP_PREREQ_SHA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_SSC, AMVP_KAS_ECC_MODE_NONE, AMVP_PREREQ_DRBG, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_SSC, AMVP_KAS_ECC_MODE_NONE, AMVP_PREREQ_HMAC, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
...
static void setup_fail(void) {
    ...
    rv = amvp_cap_kas_ecc_enable(ctx, AMVP_KAS_ECC_CDH, &dummy_handler_failure);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_CDH, AMVP_KAS_ECC_MODE_CDH, AMVP_PREREQ_ECDSA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_parm(ctx, AMVP_KAS_ECC_CDH, AMVP_KAS_ECC_MODE_CDH, AMVP_KAS_ECC_FUNCTION, AMVP_KAS_ECC_FUNC_PARTIAL);
    ...
    rv = amvp_cap_kas_ecc_enable(ctx, AMVP_KAS_ECC_COMP, &dummy_handler_failure);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_COMP, AMVP_KAS_ECC_MODE_COMPONENT, AMVP_PREREQ_ECDSA, cvalue);
    cr_assert(rv == AMVP_SUCCESS);
    rv = amvp_cap_kas_ecc_set_prereq(ctx, AMVP_KAS_ECC_COMP, AMVP_KAS_ECC_MODE_COMPONENT, AMVP_PREREQ_SHA, cvalue);
...
Test(KAS_ECC_CDH_API, empty_ctx) {
    ...
    rv  = amvp_kas_ecc_kat_handler(ctx, obj);
...
Test(KAS_ECC_API, null_ctx) {
    ...
    rv  = amvp_kas_ecc_kat_handler(NULL, obj);
...
Test(KAS_ECC_API, null_json_obj, .init = setup, .fini = teardown) {
    rv  = amvp_kas_ecc_kat_handler(ctx, NULL);
...
Test(KAS_ECC_SSC_HANDLER, good, .init = setup, .fini = teardown) {
    ...
    rv = amvp_kas_ecc_ssc_kat_handler(ctx, obj);
    cr_assert(rv == AMVP_SUCCESS);
    json_value_free(val);
}
