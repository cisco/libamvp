...
rem options
rem build libamvp statically - will also look for static dependencies
...
rem Needed for using amvp_app with a FOM that does not support NIST KDF functions, like OpenSSL fom 2.0
